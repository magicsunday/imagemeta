 ...
 * It validates the summary fields and exposure sequence extracted from the payload.
 * The suite checks endian-aware parsing and rational conversion accuracy.
 * This ensures composite image exposure data is structured consistently.
 *
...
#[UsesClass(SourceExposureTimes::class)]
