...
/**
 * Exercises Sony maker note decoding for vendor identity and payload metadata.
 ...
 * This keeps Sony maker note handling robust and predictable.
 */
...
final class SonyDecoderTest extends TestCase
{
     ...
     * Verifies the decoder still reports "Sony" regardless of the make parameter value.
     */
    #[Test]
    public function decodeUsesFixedVendorNameRegardlessOfMakeString(): void
    {
        ...
        $decoder = new SonyDecoder();
        $record  = $decoder->decode($raw, 'SONY', null);
