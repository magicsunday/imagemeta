...
final class ExifTagTest extends TestCase
{
    ...
    public function testConstantsMatchExif30(): void
    {
        $expected = [
            ...
            'CAMERA_FIRMWARE_VERSION'        => 0xA436,
            'CAMERA_FIRMWARE'                => 0xA437,
            'RAW_DEVELOPING_SOFTWARE'        => 0xA438,
            'RAW_DEVELOPING_SOFTWARE_VERSION' => 0xA439,
            'IMAGE_EDITING_SOFTWARE'         => 0xA43A,
            'METADATA_EDITING_SOFTWARE'      => 0xA43B,
            'METADATA_EDITING_SOFTWARE_VERSION' => 0xA43C,
