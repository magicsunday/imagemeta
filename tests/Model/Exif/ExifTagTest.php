...
final class ExifTagTest extends TestCase
{
    ...
    public function testConstantsMatchExif30(): void
    {
        $expected = [
            ...
            'PROFILE_HUE_SAT_MAP_DIMS'                 => 0xC726,
            'PROFILE_HUE_SAT_MAP_DATA_1'               => 0xC727,
            'PROFILE_HUE_SAT_MAP_DATA_2'               => 0xC728,
            'PROFILE_HUE_SAT_MAP_DATA_3'               => 0xC729,
            'PROFILE_LOOK_TABLE_DIMS'                  => 0xC72A,
            'PROFILE_LOOK_TABLE_DATA'                  => 0xC72B,
            'PROFILE_TONE_CURVE'                       => 0xC72C,
            'PROFILE_GAIN_TABLE_MAP'                   => 0xC72D,
