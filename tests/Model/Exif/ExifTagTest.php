...
final class ExifTagTest extends TestCase
{
    ...
    public function testConstantsMatchExif30(): void
    {
        $expected = [
            ...
            'PROFILE_HUE_SAT_MAP_DIMS'                 => 0xC6F2,
            'PROFILE_HUE_SAT_MAP_DATA_1'               => 0xC6F3,
            'PROFILE_HUE_SAT_MAP_DATA_2'               => 0xC6F4,
            'PROFILE_HUE_SAT_MAP_DATA_3'               => 0xC6F5,
            'PROFILE_LOOK_TABLE_DIMS'                  => 0xC6F6,
            'PROFILE_LOOK_TABLE_DATA'                  => 0xC6F7,
            'PROFILE_TONE_CURVE'                       => 0xC6F8,
            'PROFILE_GAIN_TABLE_MAP'                   => 0xC6F9,
