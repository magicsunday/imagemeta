...
final readonly class QuickTimeMeta
{
    ...
    private const array KEY_ALIASES = [
        ...
        'CreationDate'                         => ['com.apple.quicktime.creationdate', 'com.apple.quicktime.creationDate', 'CreationDate'],
        'com.apple.quicktime.creationdate'     => ['com.apple.quicktime.creationdate', 'com.apple.quicktime.creationDate', 'CreationDate'],
        'com.apple.quicktime.creationDate'     => ['com.apple.quicktime.creationDate', 'com.apple.quicktime.creationdate', 'CreationDate'],
