 ...
 * acceleration along the X, Y, and Z axes of the camera's coordinate system and
 * are converted to m/s².
 */
final readonly class Motion
{
     ...
     *
     * @param float|null $accelX Acceleration along the X axis in m/s².
     * @param float|null $accelY Acceleration along the Y axis in m/s².
     * @param float|null $accelZ Acceleration along the Z axis in m/s².
     */
