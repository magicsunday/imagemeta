...
final readonly class RelatedAssets
{
     ...
     * @param bool        $isPrimaryInBurst Indicates whether this asset is the selected burst frame.
    ...
    public function __construct(
        ...
        public bool $isPrimaryInBurst = false,
        public ?string $panoramaId = null,
        public ?string $depthDataId = null,
        public ?string $relatedSoundFile = null,
    ) {
    }
}
