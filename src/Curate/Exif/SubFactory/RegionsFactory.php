...
/**
 * Factory for creating Regions value objects from XMP metadata.
 */
final readonly class RegionsFactory implements SubFactoryInterface
{
    ...
    /**
     * Creates a Regions value object from XMP metadata.
     *
     * @param Metadata $metadata Metadata container with decoded EXIF, XMP and QuickTime data.
     *
     * @return Regions Regions metadata aggregate with face and region detection data.
     */
    public function create(Metadata $metadata, mixed ...$args): Regions
    {
