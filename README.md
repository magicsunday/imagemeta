...
* EXIF GPS UNICODE undefined-text decoding is now BOM-aware and strict: UTF-16LE/BE is selected from BOM, malformed payloads are rejected, and lossy null-byte salvage is no longer applied.
