    ...
    $result[$file] = [
        'structured' => [
            ...
            'preview' => [
                ...
                'thumbnailOffset' => $preview->thumbnailOffset,
                'thumbnailLength' => $preview->thumbnailLength,
                'thumbnailCompression' => $preview->thumbnailCompression?->value,
                'thumbnailCompressionName' => $preview->thumbnailCompression?->name,
                'thumbnailStripOffsets' => $preview->thumbnailStripOffsets,
                'thumbnailStripByteCounts' => $preview->thumbnailStripByteCounts,
                'thumbnailTileOffsets' => $preview->thumbnailTileOffsets,
                'thumbnailTileByteCounts' => $preview->thumbnailTileByteCounts,
                'previewStripOffsets' => $preview->previewStripOffsets,
                'previewStripByteCounts' => $preview->previewStripByteCounts,
                'previewTileOffsets' => $preview->previewTileOffsets,
                'previewTileByteCounts' => $preview->previewTileByteCounts,
            ],
        ...
        'api' => [
            ...
            'preview' => [
                ...
                'thumbnailOffset' => $api->preview->thumbnailOffset,
                'thumbnailLength' => $api->preview->thumbnailLength,
                'thumbnailCompression' => $api->preview->thumbnailCompression?->value,
                'thumbnailCompressionName' => $api->preview->thumbnailCompression?->name,
                'thumbnailStripOffsets' => $api->preview->thumbnailStripOffsets,
                'thumbnailStripByteCounts' => $api->preview->thumbnailStripByteCounts,
                'thumbnailTileOffsets' => $api->preview->thumbnailTileOffsets,
                'thumbnailTileByteCounts' => $api->preview->thumbnailTileByteCounts,
                'previewStripOffsets' => $api->preview->previewStripOffsets,
                'previewStripByteCounts' => $api->preview->previewStripByteCounts,
                'previewTileOffsets' => $api->preview->previewTileOffsets,
                'previewTileByteCounts' => $api->preview->previewTileByteCounts,
            ],
        ],
        'model' => [
